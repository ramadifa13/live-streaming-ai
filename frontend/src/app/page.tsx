    ...
    icon: (
      ...
      >
        <path
          ...
          d="M9 12h.01M15 12h.01M12 2a4 4 0 00-4 4v2H7a3 3 0 00-3 3v2a3 3 0 003 3h10a3 3 0 003-3v-2a3 3 0 00-3-3h-1V6a4 4 0 00-4-4z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M8 18v2a2 2 0 002 2h4a2 2 0 002-2v-2"
        />
      </svg>
    ),
  },
              ...
              >
                ...
                <div className="absolute left-4 top-32 flex flex-col gap-3">
                  ...
                  <div className="max-w-[200px] rounded-lg border border-white/10 bg-black/40 p-2.5 backdrop-blur-md shadow-lg">
                    ...
                    <p className="text-[10px] text-slate-200">
                      Harga spesial hari ini Rp99.000 + gratis ongkir 🚚
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute right-4 bottom-28 flex flex-col gap-2">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-pink-500 shadow-lg animate-bounce">
                    ❤️
                  </div>
                  <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-pink-500 shadow-lg translate-x-2">
                    ❤️
                  </div>
                  <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-pink-500 shadow-lg">
                    ❤️
                  </div>
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-pink-500 shadow-lg -translate-x-2">
                    ❤️
                  </div>
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-pink-500 shadow-lg translate-x-1">
                    ❤️
                  </div>
                </div>
