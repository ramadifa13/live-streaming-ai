...
const FALLBACK_CONFIG: AvatarActionConfig = {
  actions: [
    { key: "IDLE", clip: "idle", aliases: [], category: "idle", crossfadeSeconds: 0.45, promptHint: "jangan untuk kalimat yang diucapkan" },
    { key: "TALK_EXPRESSIVE", clip: "talk_expressive", aliases: ["expressive"], category: "talk", crossfadeSeconds: 0.35, promptHint: "default bicara (paling sering, ~50%)" },
    { key: "WAVE", clip: "wave", aliases: ["raise_hand"], category: "gesture", crossfadeSeconds: 0.2, promptHint: "sapaan / welcome / \"halo kak\"" },
    { key: "NOD", clip: "nod", aliases: [], category: "gesture", crossfadeSeconds: 0.15, promptHint: "setuju, \"betul kak\", \"iya benar\"" },
    { key: "LAUGH", clip: "laugh", aliases: [], category: "gesture", crossfadeSeconds: 0.2, promptHint: "candaan / ketawa" },
    { key: "POINT_UP", clip: "point_up", aliases: [], category: "gesture", crossfadeSeconds: 0.2, promptHint: "tunjuk harga, promo, stok (ke atas)" },
    { key: "POINT_DOWN", clip: "point_down", aliases: [], category: "gesture", crossfadeSeconds: 0.2, promptHint: "tunjuk harga, promo, stok (ke bawah)" },
    { key: "THINK", clip: "nod", aliases: ["think"], category: "gesture", crossfadeSeconds: 0.2, promptHint: "ragu, \"hmm\", sedang pikir" },
  ],
...
function loadConfig(): AvatarActionConfig {
  ...
  console.warn(
    "[avatar-actions] deploy/assets/avatar_actions.json tidak ditemukan — memakai fallback bawaan.",
  );
