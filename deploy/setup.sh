...
def _load_models_cached(args=None):
    ...
    cache_key = (
        ...
        getattr(args, "left_cheek_width", 45),
        getattr(args, "right_cheek_width", 45),
...
echo "============================================================"
echo ""
echo "Start worker (MuseTalk di-load ke VRAM di sini, bukan saat pembeli Go Live):"
